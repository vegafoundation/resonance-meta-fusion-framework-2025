...
\title{Meta Fusion Framework: Kavramsal Bir Çerçeve}
...
\begin{abstract}
Bu çalışma, Meta Fusion Framework'i Resonance Data ve QIRC paradigması içinde yeni bir kavramsal çerçeve olarak tanıtmaktadır.
\end{abstract}
